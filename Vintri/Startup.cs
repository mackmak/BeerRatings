...
namespace Vintri
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IBeerFactory, BeerFactory>();
            services.AddTransient<IUserResponseFactory, UserResponseFactory>();
            services.AddTransient<BaseClassDataBaseRepository, DataBaseRepository>();
